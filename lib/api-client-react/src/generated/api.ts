 ...
 */
export const aiSearch = async (searchRequest: SearchRequest, options?: Parameters<typeof customFetch>[1]): Promise<SearchResponse> => {

  return customFetch<SearchResponse>(getAiSearchUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getAiSearchMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof aiSearch>>, TError,{data: BodyType<SearchRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof aiSearch>>, TError,{data: BodyType<SearchRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof aiSearch>>, {data: BodyType<SearchRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AiSearchMutationBody = BodyType<SearchRequest>
    export type AiSearchMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary AI-powered tool search (NVIDIA NIM)
 */
export const useAiSearch = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof aiSearch>>, TError,{data: BodyType<SearchRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetSavedToolsUrl = () => {




  return `/api/workspace/saved`
}

/**
 * @summary Get saved tools for the current user
 */
export const getSavedTools = async ( options?: Parameters<typeof customFetch>[1]): Promise<SavedToolsResponse> => {

  return customFetch<SavedToolsResponse>(getGetSavedToolsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetSavedToolsQueryKey = () => {
    return [
    `/api/workspace/saved`
    ] as const;
    }
...
export const getGetSavedToolsQueryOptions = <TData = Awaited<ReturnType<typeof getSavedTools>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSavedTools>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetSavedToolsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSavedTools>>> = ({ signal }) => getSavedTools({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSavedTools>>, TError, TData> & { queryKey: QueryKey }
}

export type GetSavedToolsQueryResult = NonNullable<Awaited<ReturnType<typeof getSavedTools>>>
export type GetSavedToolsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetSavedTools<TData = Awaited<ReturnType<typeof getSavedTools>>, TError = ErrorType<ErrorEnvelope>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSavedTools>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetSavedToolsQueryOptions(options)
 ...
 */
export const saveTool = async (saveToolRequest: SaveToolRequest, options?: Parameters<typeof customFetch>[1]): Promise<SavedToolItem> => {

  return customFetch<SavedToolItem>(getSaveToolUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(saveToolRequest)
  }
);}
...
export const getSaveToolMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveTool>>, TError,{data: BodyType<SaveToolRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof saveTool>>, TError,{data: BodyType<SaveToolRequest>}, TContext> => {

const mutationKey = ['saveTool'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof saveTool>>, {data: BodyType<SaveToolRequest>}> = (props) => {
          const {data} = props ?? {};

          return  saveTool(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SaveToolMutationResult = NonNullable<Awaited<ReturnType<typeof saveTool>>>
    export type SaveToolMutationBody = BodyType<SaveToolRequest>
    export type SaveToolMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Save a tool to the current user's workspace
 */
export const useSaveTool = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveTool>>, TError,{data: BodyType<SaveToolRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof saveTool>>,
        TError,
        {data: BodyType<SaveToolRequest>},
        TContext
      > => {
      return useMutation(getSaveToolMutationOptions(options));
    }

export const getRemoveSavedToolUrl = (toolId: number,) => {




  return `/api/workspace/saved/${toolId}`
}

/**
 * @summary Remove a saved tool from the current user's workspace
 */
export const removeSavedTool = async (toolId: number, options?: Parameters<typeof customFetch>[1]): Promise<DeleteSuccess> => {

  return customFetch<DeleteSuccess>(getRemoveSavedToolUrl(toolId),
  {
    ...options,
    method: 'DELETE'
...
export const getRemoveSavedToolMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeSavedTool>>, TError,{toolId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof removeSavedTool>>, TError,{toolId: number}, TContext> => {

const mutationKey = ['removeSavedTool'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof removeSavedTool>>, {toolId: number}> = (props) => {
          const {toolId} = props ?? {};

          return  removeSavedTool(toolId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RemoveSavedToolMutationResult = NonNullable<Awaited<ReturnType<typeof removeSavedTool>>>

    export type RemoveSavedToolMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Remove a saved tool from the current user's workspace
 */
export const useRemoveSavedTool = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeSavedTool>>, TError,{toolId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof removeSavedTool>>,
        TError,
        {toolId: number},
        TContext
      > => {
      return useMutation(getRemoveSavedToolMutationOptions(options));
    }
...
export const getGetSearchHistoryUrl = () => {
  ...
  return `/api/workspace/history`
}

/**
 * @summary Get search history for the current user
 */
export const getSearchHistory = async ( options?: Parameters<typeof customFetch>[1]): Promise<SearchHistoryResponse> => {

  return customFetch<SearchHistoryResponse>(getGetSearchHistoryUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetSearchHistoryQueryOptions = <TData = Awaited<ReturnType<typeof getSearchHistory>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSearchHistory>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetSearchHistoryQueryError = ErrorType<ErrorEnvelope>
...
export function useGetSearchHistory<TData = Awaited<ReturnType<typeof getSearchHistory>>, TError = ErrorType<ErrorEnvelope>>(
